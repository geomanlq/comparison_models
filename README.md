...
| [RTTC](./RTTC_HouJiaWen)[^7]             |            Tucker factorization-based tensor completion for robust traffic data imputation             |                              Transportation Research Part C: Emerging Technologies                              | 2024.03 <br/> |
| [D-NORM](./D-NORM_XianYunchun)[^8]       |               Distributed neural tensor completion for network monitoring data recovery                |                                              Information Sciences                                               | 2024.03 <br/> |
| [MFC](./MFC_FangHao)[^9]                 |       Learning persistent community structures in dynamic networks via topological data analysis       |                          Proceedings of the AAAI Conference on Artificial Intelligence                          | 2024.03 <br/> |
| [ConvTR](./ConvTR_LiaoXin)[^10]           |                A neural tensor decomposition model for high-order sparse data recovery                 |                                              Information Sciences                                               | 2024.02 <br/> |
| [NT-DPTC](./NT_DPTC_LiuHua)[^11]         | A non-negative temporal dimension preserved tensorcompletion model for missing traffic data imputation |                                              Information Sciences                                               | 2024.01 <br/> |
| [TCDP](./TCDP_WuZhiXiang)[^12]           |  Differentially Private Federated Tensor Completion for Cloud–Edge Collaborative AIoT Data Prediction  |                                         IEEE Internet of Things Journal                                         | 2024.01 <br/> |
| [GFormer](./GFormer_Zhangchunyang)[^13]  |                                  Graph Transformer for Recommendation                                  | Proceedings of the 46th International ACM SIGIR Conference on Research and Development in Information Retrieval | 2023.07 <br/> |
| [BiasTR](./BiasTR_Wyr)[^14]              |                       Tensor Ring decomposition for context-aware recommendation                       |                                        Expert Systems with Applications                                         | 2023.05 <br/> |
| [TPR](./TPR_HeYaping)[^15]               |                      Trp: Trained rank pruning for efficient deep neural networks                      |       2019 Fifth Workshop on Energy Efficient Machine Learning and Cognitive Computing - NeurIPS Edition        | 2019.12 <br/> |
| [CUMF_CDD++](./CUMF_CCD++_HuQicong)[^16] |                             Parallel CCD++ on GPU for Matrix Factorization                             |                                     Proceedings of the General Purpose GPUs                                     | 2017.02 <br/> |
...
[^5]:D. Ahn, U. S. Saini, E. E. Papalexakis, and A. Payani, “Neural Additive Tensor Decomposition for Sparse Tensors,”
...
[^6]: H. Che, B. Pan, M. -F. Leung, Y. Cao and Z. Yan, "Tensor Factorization With Sparse and Graph Regularization
...
[^7]: C. Lyu, Q.-L. Lu, X. Wu, and C. Antoniou, “Tucker factorization-based tensor completion for robust traffic data
...
[^8]: C. Liu, K. Xie, T. Wu, C. Ma, and T. Ma, “Distributed neural tensor completion for network monitoring data
...
[^9]: D. Kong, A. Zhang, and Y. Li, “Learning Persistent Community Structures in Dynamic Networks via Topological Data
...
[^10]: T. Liao, J. Yang, C. Chen, and Z. Zheng, “A neural tensor decomposition model for high-order sparse data
recovery,”
...
[^11]: Hong Chen a Mingw Lin b, Jira Liu, “A non-negative temporal dimension preserved tensor-completion model for
...
[^12]: Z. Yang et al., "Differentially Private Federated Tensor Completion for Cloud–Edge Collaborative AIoT Data
...
[^13]: C. Li, L. Xia, X. Ren, Y. Ye, Y. Xu, and C. Huang, “Graph Transformer for Recommendation,”
...
[^14]: W. Wang, G. Sun, S. Zhao, Y. Li, and J. Zhao, “Tensor Ring decomposition for context-aware recommendation,”
...
[^15]: Y. Xu et al., “Trained Rank Pruning for Efficient Deep Neural Networks,”
