...
| [RTTC](./RTTC_HouJiaWen)[^6]             |            Tucker factorization-based tensor completion for robust traffic data imputation             |                              Transportation Research Part C: Emerging Technologies                              | 2024.03 <br/> |
| [D-NORM](./D-NORM_XianYunchun)[^7]       |               Distributed neural tensor completion for network monitoring data recovery                |                                              Information Sciences                                               | 2024.03 <br/> |
| [MFC](./MFC_FangHao)[^8]                 |       Learning persistent community structures in dynamic networks via topological data analysis       |                          Proceedings of the AAAI Conference on Artificial Intelligence                          | 2024.03 <br/> |
| [ConvTR](./ConvTR_LiaoXin)[^9]           |                A neural tensor decomposition model for high-order sparse data recovery                 |                                              Information Sciences                                               | 2024.02 <br/> |
| [NT-DPTC](./NT_DPTC_LiuHua)[^10]         | A non-negative temporal dimension preserved tensorcompletion model for missing traffic data imputation |                                              Information Sciences                                               | 2024.01 <br/> |
| [TCDP](./TCDP_WuZhiXiang)[^11]           |  Differentially Private Federated Tensor Completion for Cloud–Edge Collaborative AIoT Data Prediction  |                                         IEEE Internet of Things Journal                                         | 2024.01 <br/> |
| [GFormer](./GFormer_Zhangchunyang)[^12]  |                                  Graph Transformer for Recommendation                                  | Proceedings of the 46th International ACM SIGIR Conference on Research and Development in Information Retrieval | 2023.07 <br/> |
...
| [TPR](./TPR_HeYaping)[^14]               |                      Trp: Trained rank pruning for efficient deep neural networks                      |       2019 Fifth Workshop on Energy Efficient Machine Learning and Cognitive Computing - NeurIPS Edition        | 2019.12 <br/> |
| [CUMF_CDD++](./CUMF_CCD++_HuQicong)[^15] |                             Parallel CCD++ on GPU for Matrix Factorization                             |                                     Proceedings of the General Purpose GPUs                                     | 2017.02 <br/> |
...
[^8]: D. Kong, A. Zhang, and Y. Li, “Learning Persistent Community Structures in Dynamic Networks via Topological Data
...
[^9]: T. Liao, J. Yang, C. Chen, and Z. Zheng, “A neural tensor decomposition model for high-order sparse data
recovery,”
...
[^10]: Hong Chen a Mingw Lin b, Jira Liu, “A non-negative temporal dimension preserved tensor-completion model for
...
[^11]: Z. Yang et al., "Differentially Private Federated Tensor Completion for Cloud–Edge Collaborative AIoT Data
...
[^12]: C. Li, L. Xia, X. Ren, Y. Ye, Y. Xu, and C. Huang, “Graph Transformer for Recommendation,”
...
[^14]: Y. Xu et al., “Trained Rank Pruning for Efficient Deep Neural Networks,”
...
[^15]: I. Nisa, A. Sukumaran-Rajam, R. Kunchum, and P. Sadayappan, “Parallel CCD++ on GPU for Matrix Factorization,” in
